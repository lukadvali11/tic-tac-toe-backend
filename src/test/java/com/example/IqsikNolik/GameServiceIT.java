...
public class GameServiceIT {
    ...
    void shouldNotGetValidated() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> service.putSymbolOnBoard(gameStateId, 2, 1));
    }
